...
<tr><td><font color=tan size=4 face="Verdana">NAME :   </font>    </td><td>  <input type="text" name="Name"   onclick="this.value=''"/></td></tr> 
...
<tr><td><font color=tan size=4 face="Verdana">COMPANaY :    </font></td><td>  <input type="text" name="Company"  onclick="this.value=''"/></td></tr>
